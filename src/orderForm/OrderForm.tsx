        ...
        <div className={s.order}>
            <div className={s.order_box}>
                <div className={s.order_box_text}>
                    <div className={s.order_box_text_title}>оформление <span
                        className={s.order_box_text_titleBlue}> заказа</span></div>
                    <span
                        className={s.order_box_text_small}>Перед заполнением формы ознакомьтесь с нашей схемой работы!</span>
                </div>
                ...
                <form action="" className={s.order_box_form}>
                    <select name="" id="" className={s.order_box_form_select}>
                        <option value="">Выберите тип системы</option>
                        <option value="">Выберите тип системы1</option>
                        <option value="">Выберите тип системы2</option>
                        <option value="">Выберите тип системы3</option>
                        <option value="">Выберите тип системы4</option>

                    </select>
                    <input type="text" className={s.order_box_form_input} placeholder={'Ваш e-mail'}/>
                    <input type="text" className={s.order_box_form_input} placeholder={'Ваше имя'}/>
                    <div className={s.order_box_form_wrapperSecondLine}>
                        ...
                        <label className={s.order_box_form_label}>
                            <input type="file" name="file" className={s.order_box_form_inputFile}/>
                                <span className={s.order_box_form_span}>
                                    <svg style={{marginRight:'3px'}} width="18" height="21" viewBox="0 0 18 21" fill="none" xmlns="http://www.w3.org/2000/svg">
